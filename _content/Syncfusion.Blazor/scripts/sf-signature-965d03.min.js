...
window.sfBlazor.Signature = function () {
  ...
  function (_super) {
    ...
    SignatureBase.prototype.clear = function () {
      ...
      if (this.backgroundLoaded) {
        if (this.backgroundImage) {
          this.canvasContext.canvas.style.backgroundImage = this.backgroundImage;
        } else {
          this.canvasContext.canvas.style.backgroundColor = this.backgroundColor;
        }
    ...
    SignatureBase.prototype.saveBackground = function (savebg) {
      ...
      if (savebg) {
        this.backgroundLoaded = true; // eslint-disable-next-line @typescript-eslint/no-this-alias
  ...
  var Signature = {
    ...
    isEmpty: function isEmpty() {
      return SignatureBase.prototype.isEmpty();
    },
    canUndo: function canUndo() {
      return SignatureBase.prototype.canUndo();
    },
    canRedo: function canRedo() {
      return SignatureBase.prototype.canRedo();
    },
